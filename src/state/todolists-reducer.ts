...
type deletedTodolistsActionType = {
...
type addTodolistsActionType = { type: 'ADD-TODOLIST', nameNewTodolist: string,  todolistID: string }

export const addTodolistAC = (name: string) : addTodolistsActionType=> {
    return {
        type: 'ADD-TODOLIST',
